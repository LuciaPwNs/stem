<div id="employee_info">
	<form name='employeeDataForm' id='residencyCert'>

<h2>Residency Certification Form</h2> 
<h3>Local Earned Income Tax Withholding</h3><br><br/>

	<p><b><center>To Employers/Taxpayers:</b></center></p>
	...
	<h3>Employer Information - Employment Location</h3>
		...
		<input type="text" name="employer_business_name" class="default" readonly size="50" value="Somerset Trust Company"><br/>
		
		<input type="text" name="employer_street_addres" class="default" readonly size="50" value="151 West Main Street"><br/>

 		<input type="text" name="employer_city" class="default" readonly size="50" value="Somerset"><br/>

		<input type="text" name="employer_state" class="default" readonly size="20" value="PA"><br/>

		<input type="text" name="employer_zip" class="default" readonly size="20" value="15501"><br/>

		<input type="text" name="employer_fein" class="default" readonly size="20" value="250807970"><br/><br/>

		<input type="text" name="employer_phone" class="default" readonly size="50" value="814-443-9200"><br/>

		<input type="text" name="employer_municipality" class="default" readonly size="50" value="Somerset Boro"><br/>

		<input type="text" name="employer_county" class="default" readonly size="50" value="Somerset"><br/>

		<input type="text" name="employer_psd_code" class="default" readonly size="50" value="560903"><br/>

		<input type="text" name="employer_eit_rate" class="default" readonly size="50" value=".50"><br/><br><br/>
	...
	<h3>Certification</h3>
		...
		Date<input class="datepicker" name="employee.complete_date" type="text"><br/>
