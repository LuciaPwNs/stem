<div id="employee_info" class="clearfix">
	<cfform>
		...
		<b>1. Personal Data</b> (Required whether or not you are a participant)<br/>
			...
			<input type="datefield" name="dob" width="50"><br/><br/>

			<label for="doh">Date of Hire: </label>
			<input type="datefield" name="doh" width="50"><br/><br/>

			<label for="spouseName">Spouse Name: </label>
			<input type="text" name="spouseName" size="50"><br/>

			<label for="spouseSsn">Spouse SSN #: </label>
			<input type="text" name="spouseSsn" size="9"><br/><br/>

			<label for="spouseDob">Spouse Date of Birth: </label>
			<input type="datefield" name="spouseDob" width="50"><br/><br/>
