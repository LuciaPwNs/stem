<div id="employee_info">
	<p>
		...
		Address: <cfinput type="text" name="addressline1" size="50"><br>
				 <cfinput type="text" name="addressline2" size="50"><br>
		City: <cfinput type="text" name="city" size="25">
		State: <cfinput type="text" name="state" size="2">
		Zip: <cfinput type="text" name="zip" size="5"><br>
		SSN #: <cfinput type="text" name="ssn" size="9"><br>
		Date of Birth: <input date code><br>
		Date of Hire: <input date code><br>
