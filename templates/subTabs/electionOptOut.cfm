<div id="employee_info" class="clearfix">
	<cfform>
		...
		<b>1. Personal Data</b> (Required whether or not you are a participant)<br/>
			...
			<input type="text" name="name" size="50" placeholder="Name"><br/>
		
			<input type="text" name="addressline1" size="50" placeholder="Address Line 1"><br/>
			<input type="text" name="addressline2" size="50" placeholder="Address Line 2"><br/>

			<input type="text" name="city" size="25" placeholder="City">
			...
			<input type="date" name="dob" width="50"><br/><br/>

			<input type="date" name="doh" width="50"><br/><br/>

			<input type="text" name="spouseName" size="50" placeholder="Spouse Name"><br/>

			<input type="text" name="spouseSsn" size="9" placeholder="Spouse SSN"><br/><br/>

			<input type="date" name="spouseDob" width="50"><br/><br/>
		...
		<b>2. Medical / Vision / Dental Insurance</b><br/>
			...
			<input type="radio" name="fullCoverage" value="yes">
				I hereby elect to <b>OPT OUT</b> for the medical, vision, and dental coverage.<br/>
		...
		<b>3. Medical/Vision Insurance Only (No Dental)</b><br/>
			...
			<input type="radio" name="noDental" value="yes">
				I hereby elect to <b>OPT OUT</b> for the medical and vision coverage.<br/>
